...
Before we adjust the network structure to optimize the outcomes, let's define a yet higher encapsulation function to further condense the commands needed to execute this whole process:
